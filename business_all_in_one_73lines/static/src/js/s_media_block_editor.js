odoo.define('business_all_in_one_73lines.s_media_block_editor', function (require) {
    'use strict';
    ...
    require("business_all_in_one_73lines.s_media_block_frontend");

    var QWeb = core.qweb;

    ajax.loadXML('/business_all_in_one_73lines/static/src/xml/s_media_block_modal.xml', core.qweb);
    ...
    s_options.registry.s_media_block = s_options.Class.extend({
        ...
        video_opt: function (type, value, $li) {
            ...
            self.$modal = $(QWeb.render("business_all_in_one_73lines.s_media_block_modal"));
